    ...
    <section id="footer">
      <div class="container">
        ...
        <div class="row mt-4 pt-5">
          ...
          >
            ...
            <ul class="list-unstyled list-inline social text-center">
              ...
              <li class="list-inline-item mr-2">
                <a target="_blank" href="https://keybase.io/encrypt#polkastats"><i class="fab fa-keybase" /> PGP: 14C5 91D0 8ABA 03B7</a>
              </li>
              <li class="list-inline-item">
                <a target="_blank" href="mailto:polkastats@protonmail.com"><i class="fa fa-envelope" /> polkastats@protonmail.com</a>
              </li>
            </ul>
          </div>
          <div
        ...
        <p class="small pt-4 text-center text-white">
          ...
          <a target="_blank" href="https://colmenalabs.org" title="La Colmena">La Colmena</a>
          <span class="mx-2">|</span> Built with
          <a href="https://basicattentiontoken.org/" target="_blank">Basic Atttention Token
            <img src="/img/brave/logo-full-color.png" class="img-fluid bat"/></a>
...
.nav-bg-color {
  background-color: #000000;
  box-shadow: 0 4px 12px 0 rgba(100, 100, 100, 0.3);
}
