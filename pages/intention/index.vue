                  ...
                  <div class="col-md-3 mb-2 text-center">
                    <div v-if="hasIdentity(validator.stashId)">
                      <div v-if="getIdentity(validator.stashId).logo !== ''">
                        ...
                        <h4 class="mh-2" v-if="getIdentity(validator.stashId).username_cased !== ''">{{ getIdentity(validator.stashId).username_cased }}</h4>
                      </div>
                      <div v-else>
...
export default {
  ...
  methods: {
    getValidatorDailyGraphData: function () {
      var vm = this;
      axios.get('https://polkastats.io:8443/intention/graph/daily/' + this.accountId)
    ...
    getValidatorWeeklyGraphData: function () {
      var vm = this;
      axios.get('https://polkastats.io:8443/intention/graph/weekly/' + this.accountId)
        .then(function (response) {
    ...
    getValidatorMonthlyGraphData: function () {
      var vm = this;
      axios.get('https://polkastats.io:8443/intention/graph/monthly/' + this.accountId)
        .then(function (response) {
