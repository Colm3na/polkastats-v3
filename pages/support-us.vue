    ...
    <section>
      <b-container class="main pt-4 pb-5 support-us">
        ...
        <b-card class="mb-3">
          <div class="row">
            <div class="col-md-2 text-center">
              <img src="https://s3.amazonaws.com/keybase_processed_uploads/bd6bb92e0fa85197a2a0cf25d1a11f05_360_360.jpg" class="img-fluid" style="max-width: 80px;" v-b-tooltip.hover title="PolkaStats">
            </div>
            <div class="col-md-10">
              <nuxt-link :to="{name: 'validator', query: { accountId: `GTzRQPzkcuynHgkEHhsPBFpKdh4sAacVRsnd8vYfPpTMeEY` }}" title="PolkaStats validator details">
        ...
        <b-card class="mb-3">
          <div class="row">
            <div class="col-md-2 text-center">
              <img src="https://s3.amazonaws.com/keybase_processed_uploads/c62c205359734ddf9af1b03777703505_360_360.jpg" class="img-fluid" style="max-width: 80px;" v-b-tooltip.hover title="DragonStake">
            </div>
            <div class="col-md-10">
              <nuxt-link :to="{name: 'validator', query: { accountId: `DSpbbk6HKKyS78c4KDLSxCetqbwnsemv2iocVXwNe2FAvWC` }}" title="DragonStake validator details">
        ...
        <b-card class="mb-3">
          <div class="row">
            <div class="col-md-2 text-center">
              <img src="https://s3.amazonaws.com/keybase_processed_uploads/9769abccf1bee6c032fb5be50d6c3c05_360_360.jpg" class="img-fluid" style="max-width: 80px;" v-b-tooltip.hover title="DelegaNetworks">
            </div>
            <div class="col-md-10">
